        ...
        if IsDisabledControlJustPressed(0, 201) then
            if not self.Pressed then
                ...
                Citizen.CreateThread(function()
                    ...
                    while IsDisabledControlPressed(0, 201) and IsMouseInBounds(self.Grid.X + 20 + SafeZone.X, self.Grid.Y + 20 + SafeZone.Y, self.Grid.Width - 40, self.Grid.Height - 40) do
                        Citizen.Wait(0)
        ...
        if IsDisabledControlJustPressed(0, 201) then
            if not self.Pressed then
                ...
                Citizen.CreateThread(function()
                    self.Audio.Id = GetSoundId()
                    PlaySoundFrontend(self.Audio.Id, self.Audio.Slider, self.Audio.Library, 1)
                    while IsDisabledControlPressed(0, 201) and IsMouseInBounds(self.BackgroundBar.X + SafeZone.X, self.BackgroundBar.Y - 4 + SafeZone.Y, self.BackgroundBar.Width, self.BackgroundBar.Height + 8) do
                        Citizen.Wait(0)
                        local Progress = (math.round(GetControlNormal(0, 239) * 1920) - SafeZone.X) - self.ActiveBar.X
...
function UIMenu:ProcessControl()
    ...
    if self.Controls.Back.Enabled and (IsDisabledControlJustReleased(0, 202) or IsDisabledControlJustReleased(1, 202) or IsDisabledControlJustReleased(2, 202)) then
        self:GoBack()
    end
    ...
    if not self.UpPressed then
        if self.Controls.Up.Enabled and (IsDisabledControlJustPressed(0, 172) or IsDisabledControlJustPressed(1, 172) or IsDisabledControlJustPressed(2, 172) or IsDisabledControlJustPressed(0, 188) or IsDisabledControlJustPressed(1, 188) or IsDisabledControlJustPressed(2, 188) or IsDisabledControlJustPressed(2, 188)) then
            Citizen.CreateThread(function()
                self.UpPressed = true
                ...
                self:UpdateScaleform()
                Citizen.Wait(250)
                while self.Controls.Up.Enabled and (IsDisabledControlPressed(0, 172) or IsDisabledControlPressed(1, 172) or IsDisabledControlPressed(2, 172) or IsDisabledControlPressed(0, 188) or IsDisabledControlPressed(1, 188) or IsDisabledControlPressed(2, 188) or IsDisabledControlPressed(2, 188)) do
                    if #self.Items > self.Pagination.Total + 1 then
                        self:GoUpOverflow()
                    else
                        self:GoUp()
    ...
    if not self.DownPressed then
        if self.Controls.Down.Enabled and (IsDisabledControlJustPressed(0, 173) or IsDisabledControlJustPressed(1, 173) or IsDisabledControlJustPressed(2, 173) or IsDisabledControlJustPressed(0, 187) or IsDisabledControlJustPressed(1, 187) or IsDisabledControlJustPressed(2, 187)) then
            Citizen.CreateThread(function()
                ...
                self:UpdateScaleform()
                Citizen.Wait(250)
                while self.Controls.Down.Enabled and (IsDisabledControlPressed(0, 173) or IsDisabledControlPressed(1, 173) or IsDisabledControlPressed(2, 173) or IsDisabledControlPressed(0, 187) or IsDisabledControlPressed(1, 187) or IsDisabledControlPressed(2, 187)) do
                    if #self.Items > self.Pagination.Total + 1 then
                        self:GoDownOverflow()
                    else
                        self:GoDown()
    ...
    if not self.LeftPressed then
        if self.Controls.Left.Enabled and (IsDisabledControlPressed(0, 189) or IsDisabledControlPressed(1, 189) or IsDisabledControlPressed(2, 189)) then
            Citizen.CreateThread(function()
                self.LeftPressed = true
                self:GoLeft()
                Citizen.Wait(175)
                while self.Controls.Left.Enabled and (IsDisabledControlPressed(0, 189) or IsDisabledControlPressed(1, 189) or IsDisabledControlPressed(2, 189)) do
                    self:GoLeft()
                    Citizen.Wait(125)
                end
    ...
    if not self.RightPressed then
        if self.Controls.Right.Enabled and (IsDisabledControlPressed(0, 190) or IsDisabledControlPressed(1, 190) or IsDisabledControlPressed(2, 190)) then
            Citizen.CreateThread(function()
                self.RightPressed = true
                self:GoRight()
                Citizen.Wait(175)
                while self.Controls.Right.Enabled and (IsDisabledControlPressed(0, 190) or IsDisabledControlPressed(1, 190) or IsDisabledControlPressed(2, 190)) do
                    self:GoRight()
                    Citizen.Wait(125)
                end
