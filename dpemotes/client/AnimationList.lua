...
DP.Dances = {
   ...
   ["breakdance"] = {"divined@fndances2@new", "dfdance2", "Breakdance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["breakdance2"] = {"divined@breakdances@new", "divbdance6", "Breakdance 2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["breakdance3"] = {"divined@breakdances@new", "divbdance7", "Breakdance 3", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["breakdance4"] = {"divined@breakdances@new", "divbdance3", "Breakdance 4", AnimationOptions =
   {
   }},
   ["breakdance5"] = {"divined@breakdances@new", "divbdance4", "Breakdance 5", AnimationOptions =
   {
   }},
   ["breakdance6"] = {"divined@breakdances@new", "divbdance8", "Breakdance 6", AnimationOptions =
   {
   }},
   ["breakdance7"] = {"divined@breakdances@new", "divbdance9", "Breakdance 7", AnimationOptions =
   {
   }},
   ["breakdancefail"] = {"divined@mocap@new", "breakdancefail", "Breakdance Fail", AnimationOptions =
   {
       EmoteLoop = true
   }},

   ["newdance"] = {"divined@dancesv2@new", "divdance1", "New Dance #1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance2"] = {"divined@dancesv2@new", "divdance2", "New Dance #2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance3"] = {"divined@dancesv2@new", "divdance3", "New Dance #3", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance4"] = {"divined@dancesv2@new", "divdance4", "New Dance #4", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance5"] = {"divined@dancesv2@new", "divdance5", "New Dance #5", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance6"] = {"divined@dancesv2@new", "divdance6", "New Dance #6", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance7"] = {"divined@dancesv2@new", "divdance7", "New Dance #7", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance8"] = {"divined@dancesv2@new", "divdance8", "New Dance #8", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["macarena"] = {"divined@dancesv2@new", "divdance9", "Macarena", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance10"] = {"divined@dancesv2@new", "divdance10", "New Dance #10", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance11"] = {"divined@dancesv2@new", "divdance11", "New Dance #11", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance12"] = {"divined@dancesv2@new", "divdance12", "New Dance #12", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance13"] = {"divined@dancesv2@new", "divdance13", "New Dance #13", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newdance14"] = {"divined@dancesv2@new", "divdance14", "New Dance #e14", AnimationOptions =
   {
       EmoteLoop = true
   }},
   
   ["woowalk"] = {"div@woowalk@test", "woowalk", "Woo Walk #1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["woowalk2"] = {"divined@drpack@new", "woowalkinx", "Woo Walk #2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["bloodwalk"] = {"divined@drpack@new", "bloodwalk", "Blood Walk #1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["bloodwalk2"] = {"div@woowalk@test", "bloodwalk2", "Blood Walk #2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["cripwalk"] = {"divined@loop@new", "cwalk3", "Crip Walk #1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["cripwalk2"] = {"div@woowalk@test", "cripwalk2", "Crip Walk #2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["cripwalk3"] = {"divined@drpack@new", "cripwalk3", "Crip Walk #3", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["shootit"] = {"divined@drpack@new", "shootit", "Shoot It Dance", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ...
   ["poplove"] = {"divined@drpack@new", "whatyouknowboutlove", "Pop Love", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ...
   ["newtwerk"] = {"divined@drillb2@new", "twerkmocap2", "New Twerk #1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["newtwerk2"] = {"divined@drillb2@new", "twerking", "New Twerk #2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["twerksplits"] = {"divined@drillb2@new", "splitstwerk2", "Twerk Splits", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["twerkchacha1"] = {"divined@drpackv3@new", "chatwerk1", "Twerk Cha Cha #1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["twerkchacha2"] = {"divined@drpackv3@new", "chatwerk2", "Twerk Cha Cha #2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["twerklow1"] = {"divined@drpackv3@new", "ctwerk1", "Twerk Low #1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["twerklow2"] = {"divined@drpackv3@new", "ctwerk2", "Twerk Low #2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ...
   ["griddystreet"] = {"divined@drpackv3@new", "streetgriddy", "Griddy (Street Style)", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["griddyfootball"] = {"divined@drpackv3@new", "footballgriddy", "Griddy (Football Dance)", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["industrybaby"] = {"divined@drpackv3@new", "industrybaby", "Industry Baby", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["getsturdy"] = {"divined@drpackv3@new", "kaisturdy", "Get Sturdy", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ...
   ["poppin"] = {"divined@drpackv3@new", "poppin", "Poppin'", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["yeahyeahnudy"] = {"divined@drpackv3@new", "yeahyeahnudy", "Yeah Yeah Nudy", AnimationOptions =
   {
       EmoteLoop = true
   }},

   ["bbd"] = {"divined@pack@new", "dpack_1", "BBD", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["confused"] = {"divined@pack@new", "dpack_2", "Confused", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["intensity"] = {"divined@pack@new", "dpack_3", "Intensity", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["jiggy"] = {"divined@pack@new", "dpack_4", "Jiggy", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["effortless"] = {"divined@pack@new", "dpack_7", "Effortless", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["narutorun"] = {"divined@pack@new", "dpack_8", "Naruto Run", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["saltydance"] = {"divined@pack@new", "dpack_9", "Salty", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   
   ["underwater"] = {"divined@pack@new", "dpack_10", "Underwater", AnimationOptions =
   {
       EmoteLoop = true,
   }},
      ["wdance"] = {"divined@pack@new", "dpack_11", "Take the W", AnimationOptions =
   {
       EmoteLoop = true,
   }},
      ["technozombie"] = {"divined@pack@new", "dpack_12", "Techno Zombie", AnimationOptions =
   {
       EmoteLoop = true,
   }},
      ["trae"] = {"divined@pack@new", "dpack_13", "Trae", AnimationOptions =
   {
       EmoteLoop = true,
   }},
      ["runningdance"] = {"divined@pack@new", "dpack_14", "Running Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
      ["twinkletoes"] = {"divined@pack@new", "dpack_15", "Twinkle Toes", AnimationOptions =
   {
       EmoteLoop = true,
   }},
      ["vivid"] = {"divined@pack@new", "dpack_16", "Vivid", AnimationOptions =
   {
       EmoteLoop = true,
   }},
      ["wacky"] = {"divined@pack@new", "dpack_17", "Wacky", AnimationOptions =
   {
       EmoteLoop = true,
   }},
      ["wiggle"] = {"divined@pack@new", "dpack_18", "Wiggle", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["warehousedance"] = {"divined@fndances2@new", "dfdance1", "Warehouse Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["treadmill"] = {"divined@fndances2@new", "dfdance3", "Treadmill", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["shootdance"] = {"divined@fndances2@new", "dfdance4", "Shoot Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["swimdance"] = {"divined@fndances2@new", "dfdance5", "Swim Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["jumpstyledance"] = {"divined@fndances2@new", "dfdance6", "Jumpstyle Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["goatdance"] = {"divined@fndances2@new", "dfdance7", "GOAT Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["glowstickdance"] = {"divined@fndances2@new", "dfdance8", "Glowstick Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["crazydance"] = {"divined@fndances2@new", "dfdance9", "Crazy Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["gothswing"] = {"divined@fndances2@new", "dfdance10", "Goth Swing", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["wavedance"] = {"divined@fndances2@new", "dfdance11", "Wave Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["pumpkindance"] = {"divined@fndances2@new", "dfdance12", "Pumpkin Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["wigglydance"] = {"divined@fndances2@new", "dfdance13", "Wiggly Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["shuffle"] = {"divined@pack@new", "dpack_5", "Shuffle #1", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["shuffle2"] = {"divined@loop@new", "dshuffle3", "Shuffle #2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["shufflecharleston"] = {"divined@loop@new", "charleston", "Charleston Shuffle", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["shuffleindian"] = {"divined@fndances2@new", "dfdance14", "Indian Shuffle", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["saltonlakedance"] = {"divined@fndances2@new", "dfdance15", "Salton Lake Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["gwaradance"] = {"divined@fndances2@new", "dfdance16", "Gwara Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["zippydance"] = {"divined@fndances2@new", "dfdance17", "Zippy Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["stringdance"] = {"divined@fndances2@new", "dfdance19", "String Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["ldance"] = {"divined@fndances2@new", "dfdance20", "L Dance", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["atlstomp"] = {"divined@loop@new", "atlstomp", "ATL Stomp", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["billybounce"] = {"divined@loop@new", "billybounce", "Billy Bounce", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["crisscross"] = {"divined@loop@new", "crisscross", "Criss Cross", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["dsteptwist"] = {"divined@loop@new", "dsteptwist", "D - Step - Twist", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["hitthequan"] = {"divined@loop@new", "hitthequan", "Hit The Quan", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["kneeflex"] = {"divined@loop@new", "kneeflex", "Knee Flex", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["millyrock3"] = {"divined@loop@new", "millyrock3", "Milly-Rock", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["thefloss"] = {"divined@loop@new", "thefloss", "The Floss", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["thelean"] = {"divined@loop@new", "thelean", "The Lean", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["tstep"] = {"divined@loop@new", "tstep", "T Step", AnimationOptions =
   {
       EmoteLoop = true
   }},

   ["mattitudewalk"] = {"divined@mocap@new", "attitudewalk", "Attitude Walk", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mbrushitoff"] = {"divined@mocap@new", "brushitoff", "Brush It Off", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mbunnyhop"] = {"divined@mocap@new", "bunnyhop", "Bunny-Hop", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mcatdaddy"] = {"divined@mocap@new", "catdaddy", "Cat Daddy", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mclappingjog"] = {"divined@mocap@new", "clappingjog", "Clapping Jog", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mcrankit"] = {"divined@mocap@new", "crankit", "Crank It", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mcrisscross"] = {"divined@mocap@new", "crisscross", "Criss Cross", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mdrunkdance1"] = {"divined@mocap@new", "drunkdance1", "Drunk Dance 1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mdrunkdance2"] = {"divined@mocap@new", "drunkdance2", "Drunk Dance 2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mflappywings"] = {"divined@mocap@new", "flappywings", "Flappy Wings", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mhiphopsprinkler"] = {"divined@mocap@new", "hiphopsprinkler", "Hip Hop Sprinkler", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mhitdemfolk"] = {"divined@mocap@new", "hitdemfolk", "Hit Dem Folk", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mhandjive"] = {"divined@mocap@new", "handjive", "Hand Jive", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["mleanbackdance"] = {"divined@mocap@new", "leanbackdance", "Lean Back Dance", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["makeitrain"] = {"divined@mocap@new", "makeitrain", "Make It Rain", AnimationOptions =
   {
       Prop = 'prop_anim_cash_pile_01',
       PropBone = 60309,
       PropPlacement = {0.0, 0.0, 0.02, 180.0, 0.0, 70.0},
       EmoteLoop = true
   }},
   ["jookinbounce"] = {"divined@mocap@new", "jookinbounce", "Jookin Bounce", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["movinlikebernie"] = {"divined@mocap@new", "movinlikebernie", "Movin Like Bernie", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["popoandlock"] = {"divined@mocap@new", "popandlock", "Pop n' Lock", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["schmoneydance"] = {"divined@mocap@new", "schmoneydance", "Schmoney Dance", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["shootdance"] = {"divined@mocap@new", "shootdance", "Shoot Dance", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["spankthat"] = {"divined@mocap@new", "spankthat", "Spank That", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["stankyleg"] = {"divined@mocap@new", "stankyleg", "Stanky Leg", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["stevemartindance"] = {"divined@mocap@new", "stevemartindance", "Steve Martin Dance", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["subtledab"] = {"divined@mocap@new", "subtledab", "Subtle Dab", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["thedougie2"] = {"divined@mocap@new", "thedougie2", "The Dougie", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["twerk"] = {"divined@mocap@new", "twerk", "Twerk", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["sadance1"] = {"divined@samp@new", "danceloop", "San Andreas Dance #1", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["sadance2"] = {"divined@samp@new", "danceloop2", "San Andreas Dance #2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["sadance3"] = {"divined@samp@new", "dancema", "San Andreas Dance #3", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["sadance4"] = {"divined@samp@new", "dancemb", "San Andreas Dance #4", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["sadance5"] = {"divined@samp@new", "dancemc", "San Andreas Dance #5", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["sadance6"] = {"divined@samp@new", "dancemd", "San Andreas Dance #6", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["sadance7"] = {"divined@samp@new", "danceme", "San Andreas Dance #7", AnimationOptions =
   {
       EmoteLoop = true
   }},
...
--    }},
   ...
   ["mime"] = {"divined@pack@new", "dpack_6", "Mime", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["meditate"] = {"rcmcollect_paperleadinout@", "meditiate_idle", "Meditate", AnimationOptions = -- CHANGE ME
   {
       EmoteLoop = true,
   }},
   ["meditate2"] = {"rcmepsilonism3", "ep_3_rcm_marnie_meditating", "Meditate 2", AnimationOptions = -- CHANGE ME
   {
       EmoteLoop = true,
   }},
   ["meditate3"] = {"rcmepsilonism3", "base_loop", "Meditate 3", AnimationOptions = -- CHANGE ME
   {
       EmoteLoop = true,
   }},
   ...
   ["gangsign"] = {"mp_player_int_uppergang_sign_a", "mp_player_int_gang_sign_a", "Gang Sign 1", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["gangsign3"] = {"mikey@gangsigns@new", "mgangsign_1", "Gang Sign 3", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign4"] = {"mikey@gangsigns@new", "mgangsign_2", "Gang Sign 4", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign5"] = {"mikey@gangsigns@new", "mgangsign_3", "Gang Sign 5", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign6"] = {"mikey@gangsigns@new", "mgangsign_4", "Gang Sign 6", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign7"] = {"mikey@gangsigns@new", "mgangsign_5", "Gang Sign 7", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign8"] = {"mikey@gangsigns@new", "mgangsign_6", "Gang Sign 8", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign9"] = {"mikey@gangsigns@new", "mgangsign_7", "Gang Sign 9", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign10"] = {"mikey@gangsigns@new", "mgangsign_8", "Gang Sign 10", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign11"] = {"mikey@gangsigns@new", "mgangsign_9", "Gang Sign 11", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign12"] = {"mikey@gangsigns@new", "mgangsign_10", "Gang Sign 12", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
   ["gangsign13"] = {"mikey@gangsigns@new", "mgangsign_11", "Gang Sign 13", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
...
--    }},
   ...
   ["intimidate"] = {"move_m@intimidation@idle_a", "idle_a", "Intimidate", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
...
--    ["atm"] = {"Scenario", "PROP_HUMAN_ATM", "ATM"},
   ...
   ["smokejoint"] = {"MaleScenario", "WORLD_HUMAN_DRUG_DEALER", "Smoke a Joint"},
